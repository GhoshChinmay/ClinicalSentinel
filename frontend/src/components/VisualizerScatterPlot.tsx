...
interface VisualizerScatterPlotProps {
    data: VizData;
    varX: string;
    varY: string;
...
export default function VisualizerScatterPlot({ data, varX, varY, setVarX, setVarY }: VisualizerScatterPlotProps) {
...
function LineOfBestFit({ scatterData }: {
    scatterData: {
        xMin: number;
        xMax: number;
        yMin: number;
